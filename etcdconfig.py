...
traef1 = j.clients.zos.get('traef1',data={'host':nodes[0]})
traef2 = j.clients.zos.get('traef2',data={'host':nodes[1]})
traef2 = j.clients.zos.get('traef3',data={'host':nodes[3]})
...
#
mgmtip1 = trcont1.client.ip.addr.list(mgmtnic)
